...
L.PM.Curve = L.Class.extend({
    initialize(map) {
        ...
        map.pm._latlngFunctions.push({type: L.Curve, fnc: L.PM.Curve.Utils.getPointsOnCurve});
        map.pm._snappingFilters.push((layer)=>layer instanceof L.Curve && layer._coords);
        ...
        function initCurve() {
            ...
            if (L.PM.optIn) {
                ...
                this.pm = new L.PM.Edit.Curve(this);
                this.pm.setOptions({snapSegment: false});
            }
        }
